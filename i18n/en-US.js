...
export default {
  ...
  "panel.cloudSync.automaticHelp": "Local OPFS / IndexedDB always saves the current chat. Automatic sync updates the remote replica after content changes, chat switches, and similar triggers; offline status never blocks local commits.",
  "panel.cloudSync.manualHelp": "Local OPFS / IndexedDB continues saving normally. Manual backup only stops automatic uploads; use the buttons below when another device needs to take over.",
