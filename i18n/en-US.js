...
export default {
  ...
  "panel.agent.modelHelp": "BME Agent uses this dedicated model and never borrows the active chat model or DOA Agent model.",
  "panel.agent.providerHelp": "Memory Steward, Recall Agent, and ENA share this BME-only connection. OpenAI-compatible, Anthropic Claude, and Google AI Studio / Gemini endpoints are supported.",
  "panel.agent.guardTitle": "Agent guardrails",
  "panel.agent.guardHelp": "Context is compacted by tokens. Tool and runtime limits only stop runaway background tasks.",
  "panel.agent.contextWindow": "Context window (tokens)",
  "panel.agent.maxTools": "Background tool-call limit",
  "panel.agent.maxMinutes": "Background runtime limit (minutes)",
  ...
  "llm.providerHelp.auto": "BME Agent requires its own API URL and model; it never reuses the active chat model or DOA model. OpenAI-compatible, Anthropic Claude, and Google AI Studio / Gemini endpoints are supported.",
