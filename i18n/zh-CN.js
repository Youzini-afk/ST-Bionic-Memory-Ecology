...
export default {
  ...
  "panel.taskNav.agentFlow": "Agent 执行流",
  ...
  "panel.runtimeMode.aria": "记忆运行模式",
  "panel.runtimeMode.workflow": "工作流",
  "panel.runtimeMode.workflowHint": "按既定开关和参数运行完整记忆工作流。",
  "panel.runtimeMode.agentHint": "Agent 每轮自主决定召回深度与记忆工作，复用同一聊天图谱和既有能力边界。",
  "panel.runtimeMode.agentCadenceNote": "Agent 会在每条新 AI 回复后于后台判断是否需要写入记忆；“每 N 条回复”“惊奇触发”和“自动提取晚一楼”仍保留给工作流模式，其他能力开关和参数继续约束 Agent 调用的同一套流程。",
  "panel.agentRuntime.title": "Agent 运行边界",
  "panel.agentRuntime.subtitle": "仅在 Agent 模式使用。Agent 使用上方独立配置的 BME 记忆 LLM；未配置或模型不支持工具调用时安全回退工作流。上下文接近窗口时自动总结，工具次数与运行时间只负责阻止失控循环。",
  "panel.agentRuntime.contextWindow": "上下文窗口（tokens）",
  "panel.agentRuntime.maxTools": "单任务工具调用上限",
  "panel.agentRuntime.maxMinutes": "单任务运行上限（分钟）",
  "panel.agentRuntime.help": "模式切换不会迁移或复制记忆：两种模式始终读写当前聊天的同一份图谱、同一套回退和同步数据。",
  ...
  "panel.agentFlow.kicker": "AGENT 运行",
  "panel.agentFlow.title": "Agent 执行流",
  "panel.agentFlow.desc": "实时查看模型输出、工具调用与记忆决策；原始参数和结果按需展开。",
  "panel.agentFlow.tool.memoryContext": "读取记忆任务上下文",
  "panel.agentFlow.tool.memoryContextRunning": "正在读取当前聊天与图谱状态",
  "panel.agentFlow.tool.memoryPipeline": "执行记忆管线",
  "panel.agentFlow.tool.memoryPipelineRunning": "正在执行既有记忆工作流",
  "panel.agentFlow.tool.noChanges": "确认本轮无需改动",
  "panel.agentFlow.tool.noChangesRunning": "正在结束本轮记忆维护",
  "panel.agentFlow.tool.recallContext": "读取召回上下文",
  "panel.agentFlow.tool.recallContextRunning": "正在整理候选记忆与本轮输入",
  "panel.agentFlow.tool.recallSearch": "搜索相关记忆",
  "panel.agentFlow.tool.recallSearchRunning": "正在搜索相关记忆",
  "panel.agentFlow.tool.recallGet": "读取记忆详情",
  "panel.agentFlow.tool.recallGetRunning": "正在读取记忆详情",
  "panel.agentFlow.tool.recallNeighbors": "探索记忆关系",
  "panel.agentFlow.tool.recallNeighborsRunning": "正在沿图谱关系继续查找",
  "panel.agentFlow.tool.recallPublish": "发布召回结果",
  "panel.agentFlow.tool.recallPublishRunning": "正在确定本轮注入的记忆",
  "panel.agentFlow.tool.generic": "工具 · {name}",
  "panel.agentFlow.tool.genericRunning": "工具正在执行",
  "panel.agentFlow.tool.failed": "工具执行失败",
  "panel.agentFlow.tool.completed": "工具已完成",
  "panel.agentFlow.summary.memoryContext": "已读取 {messages} 条消息，当前图谱有 {nodes} 个节点 / {edges} 条关系",
  "panel.agentFlow.summary.processedFloor": "记忆管线已处理到第 {floor} 楼",
  "panel.agentFlow.summary.pipelineCompleted": "记忆管线已完成",
  "panel.agentFlow.summary.noChangesFloor": "本轮无需更改，已确认到第 {floor} 楼",
  "panel.agentFlow.summary.noChanges": "本轮无需更改",
  "panel.agentFlow.summary.recallContext": "候选 {candidates} 条，基线已选 {selected} 条",
  "panel.agentFlow.summary.recallSearch": "找到 {count} 条候选记忆",
  "panel.agentFlow.summary.recallGet": "读取 {count} 条记忆，缺失 {missing} 条",
  "panel.agentFlow.summary.recallNeighbors": "发现 {relations} 条关系、{neighbors} 个相邻记忆",
  "panel.agentFlow.summary.recallPublished": "已发布 {count} 条记忆用于本轮召回",
  "panel.agentFlow.summary.recallRejected": "召回结果未发布",
  "panel.agentFlow.agent.steward": "记忆管家",
  "panel.agentFlow.agent.recall": "记忆召回",
  "panel.agentFlow.agent.generic": "记忆 Agent",
  "panel.agentFlow.status.completedFallback": "已自动接管",
  "panel.agentFlow.status.starting": "准备中",
  "panel.agentFlow.status.model": "请求模型",
  "panel.agentFlow.status.streaming": "模型输出中",
  "panel.agentFlow.status.decision": "解析决策",
  "panel.agentFlow.status.tool": "工具执行中",
  "panel.agentFlow.status.tool-result": "处理工具结果",
  "panel.agentFlow.status.tool-interrupted": "工具已中断",
  "panel.agentFlow.status.compaction": "压缩上下文",
  "panel.agentFlow.status.cancelling": "正在停止",
  "panel.agentFlow.status.completed": "已完成",
  "panel.agentFlow.status.suspended": "已挂起",
  "panel.agentFlow.status.failed": "失败",
  "panel.agentFlow.status.cancelled": "已停止",
  "panel.agentFlow.status.running": "运行中",
  "panel.agentFlow.scope.floorRange": "第 {start}–{end} 楼",
  "panel.agentFlow.scope.recallCandidates": "本轮候选 {count} 条",
  "panel.agentFlow.scope.currentChat": "当前聊天",
  "panel.agentFlow.event.started": "开始本轮 Agent 任务",
  "panel.agentFlow.event.compaction": "生成上下文摘要",
  "panel.agentFlow.event.modelRound": "模型回合 {number}",
  "panel.agentFlow.event.contextCompacted": "上下文已压缩",
  "panel.agentFlow.event.contextCompactedSummary": "约 {before} tokens → {after} tokens",
  "panel.agentFlow.event.completed": "Agent 任务完成",
  "panel.agentFlow.event.suspended": "Agent 任务挂起",
  "panel.agentFlow.event.failed": "Agent 任务失败",
  "panel.agentFlow.event.cancelled": "Agent 任务已停止",
  "panel.agentFlow.event.fallbackCompleted": "Agent 未完成的部分已由现有记忆流程继续完成",
  "panel.agentFlow.event.olderCollapsed": "已折叠 {count} 条较早记录",
  "panel.agentFlow.diagnostics": "诊断详情",
  "panel.agentFlow.arguments": "调用参数",
  "panel.agentFlow.result": "原始结果",
  "panel.agentFlow.groupedCalls": "查看连续 {count} 次调用",
  "panel.agentFlow.groupedCallsClipped": "较早的 {count} 次调用未在实时视图展开",
  "panel.agentFlow.previewClipped": "内容较长，已省略前 {count} 个字符，仅显示末尾",
  "panel.agentFlow.live": "实时",
  "panel.agentFlow.waitingForModel": "正在接收模型输出…",
  "panel.agentFlow.noTextOutput": "模型未输出文本，直接发起工具调用",
  "panel.agentFlow.reasoning": "模型推理",
  "panel.agentFlow.sessionRuns": "当前聊天",
  "panel.agentFlow.emptyTitle": "还没有 Agent 运行记录",
  "panel.agentFlow.emptyBody": "启用 Agent 模式后，提取、召回与记忆维护过程会实时显示在这里。",
  "panel.agentFlow.metric.model": "模型 {count} 次",
  "panel.agentFlow.metric.tools": "工具 {count} 次",
  "panel.agentFlow.metric.tokens": "{count} tokens",
  "panel.agentFlow.stop": "停止",
  "panel.agentFlow.cancelFailed": "无法停止当前 Agent 任务",
  ...
  "panel.cloudSync.title": "云端同步",
  "panel.cloudSync.subtitle": "Cloud Sync 是浏览器本地存储的多设备副本；自动同步按触发时机更新当前聊天副本，手动备份只在你操作时上传或恢复。",
  "panel.cloudSync.modeLabel": "同步方式",
  "panel.cloudSync.automaticOption": "自动同步",
  "panel.cloudSync.manualOption": "手动备份",
  "panel.cloudSync.automaticHelp": "普通 SillyTavern 使用本地 OPFS / IndexedDB 保存当前聊天；自动同步会在内容变更、切换聊天等触发时更新远端副本，离线不会阻止本地提交。",
  "panel.cloudSync.manualHelp": "普通 SillyTavern 的本地 OPFS / IndexedDB 仍会正常保存；手动备份只停止自动上传，需要接力时请使用下方上传/恢复按钮。",
  "panel.cloudSync.authorityHelp": "当前聊天使用 Authority SQL 共享主存储，自动 Cloud Sync 不会再复制第二份主图谱；如需独立快照，可选择手动备份并使用下方按钮。",
  "panel.cloudSync.lukerHelp": "当前聊天使用 Luker chat-state 主存储，自动 Cloud Sync 已停用；如需独立快照，可选择手动备份并使用下方按钮。",
  "panel.graphLoad.refreshFailed": "刷新当前聊天的存储状态失败：{error}",
