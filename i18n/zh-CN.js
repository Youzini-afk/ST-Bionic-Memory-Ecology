...
export default {
  ...
  "panel.cloudSync.automaticHelp": "本地 OPFS / IndexedDB 始终保存当前聊天；自动同步会在内容变更、切换聊天等触发时更新远端副本，离线不会阻止本地提交。",
  "panel.cloudSync.manualHelp": "本地 OPFS / IndexedDB 仍会正常保存；手动备份只停止自动上传，需要接力时请使用下方上传/恢复按钮。",
