...
const PRODUCT_CONTRACT_TESTS = [
  ...
  "durable-reroll-fail-closed.mjs",
  "ena-planner-plots.mjs",
  "event-binding-priority.mjs",
  "identity-resolver.mjs",
  "indexeddb-sync.mjs",
  "legacy-ledger-migration.mjs",
  "ledger-ui-actions.mjs",
  "luker-host-adapter.mjs",
  "luker-memory-ledger-store.mjs",
  "manual-memory-service.mjs",
  "memory-branch.mjs",
  ...
  "memory-ledger-cloud-merge.mjs",
  "memory-ledger-storage.mjs",
  "memory-ledger-store-router.mjs",
  "memory-query.mjs",
  ...
  "panel-bridge.mjs",
  "panel-ena-debug.mjs",
  "phase6-live-owner-contract.mjs",
  "phase6-production-cutover-contract.mjs",
  "planner-artifact-service.mjs",
